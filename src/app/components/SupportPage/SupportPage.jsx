    ...
    <PageWrapper>
      ...
      <HeaderSection>
        ...
        <Typography variant="body1" color="text.secondary">
          Can&apos;t find what you need in the FAQ? Share a few details below and our team will help
          ...
          <Grid item xs={12} md={8}>
            <SupportCard component="section" aria-labelledby="support-form-heading">
              <Box display="flex" alignItems="center" mb={2}>
                ...
                <Typography id="support-form-heading" variant="h6" fontWeight={600} component="h2">
